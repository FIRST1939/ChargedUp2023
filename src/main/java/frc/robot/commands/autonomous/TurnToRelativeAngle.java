...
public class TurnToRelativeAngle extends PIDCommand {
    ...
    public boolean isFinished () {
        boolean done=Math.abs(westCoastDrive.getHeading() - getController().getSetpoint()) < Constants.AutonomousConstants.TURNING_ANGLE_TOLERANCE;
        System.out.println("Turn is done: " + done + "H: " + westCoastDrive.getHeading() + "SP:" + getController().getSetpoint() ) ;
        return done; }
}
