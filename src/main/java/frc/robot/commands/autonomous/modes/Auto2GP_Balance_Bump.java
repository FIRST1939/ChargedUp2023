...
public class Auto2GP_Balance_Bump extends SequentialCommandGroup{
    
    public Auto2GP_Balance_Bump (WestCoastDrive westCoastDrive, AHRS navX, Cubert cubert, Manipulator manipulator, LEDs leds) {
        ...
        this.addCommands(
            ...
            new ParallelDeadlineGroup (
                new SequentialCommandGroup(
                    ...
                    new DriveRampedDistance(westCoastDrive, 1.5),
