...
public class RunMechanisms extends CommandBase {
    ...
    public RunMechanisms (Indexer indexer, Manipulator manipulator, DoubleSupplier indexerSupplier, DoubleSupplier manipulatorSupplier) {
